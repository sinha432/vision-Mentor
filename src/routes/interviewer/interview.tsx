...
function InterviewRoom() {
    ...
    (event: DetectionEvent) => {
      switch (event.kind) {
        ...
        case "multiple_people":
          ...
          multiPeopleTimeoutRef.current = window.setTimeout(() => setMultiPeopleBanner(false), 5000);
      ...
      try {
        ...
        if (check.secondSpeaker || check.musicOrTv) {
          flagIntegrity(
            ...
            check.notes || (check.secondSpeaker ? "A second speaker was heard." : "Background music or TV was heard."),
            20_000,
            check.confidence,
          );
  ...
  const persist = useCallback(
    ...
    [config, sessionId, elapsed, vision, voice, coaching, proctor, detection, endReason],
  );
